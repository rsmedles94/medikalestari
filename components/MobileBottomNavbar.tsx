...
const MobileBottomNavbar = () => {
    ...
    },
    {
      ...
      solid: (
        <g>
          ...
          <path
            d="M12 6v6l4 2"
            stroke="#003369" // Memberikan warna kontras di dalam solid icon
            strokeWidth="1.8"
            strokeLinecap="round"
          />
        </g>
    ...
    },
    {
      ...
      solid: (
        <g>
          ...
          <path stroke="#003369" strokeWidth="1.5" d="M9 7h6M9 11h6M9 15h6" />
        </g>
      ),
    },
  ];
  ...
  return (
    <>
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-[#003369] z-50 border-t border-white/5 pb-safe">
