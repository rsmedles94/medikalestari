...
const MobileBottomNavbar = () => {
    ...
    },
    {
      ...
      solid: (
        <g>
          ...
          <path stroke="#153d6f" strokeWidth="1.5" d="M9 7h6M9 11h6M9 15h6" />
        </g>
      ),
    },
  ];
  ...
  return (
    <>
      {!isSearchOpen && (
        <nav
          className="md:hidden fixed bottom-0 left-0 right-0 bg-[#153d6f] z-50 border-t border-white/5 pb-safe"
