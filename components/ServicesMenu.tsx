            ...
            {services.map((service) => {
              ...
              return (
                ...
                >
                  <Link
                    href={service.href}
                    className="group flex items-center justify-between p-6 md:p-8 h-full min-h-[92px] transition-all duration-200 text-[#00796e] hover:bg-[#00796e] hover:text-white"
                  >
