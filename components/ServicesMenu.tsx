        ...
        >
          {services.map((service) => (
            ...
            >
              ...
              >
                <div className="mb-3 text-[#006360] transition-colors">
                  {service.icon}
                </div>
                <span className="text-center text-[10px] md:text-sm font-medium text-gray-600 leading-tight group-hover:text-[#009C96]">
                  {service.label}
                </span>
              </Link>
            </motion.div>
