              ...
              <div className="flex-1 text-left">
                ...
                <div className="flex flex-wrap justify-start gap-2 md:gap-3">
                  <button
                    ...
                    className="px-4 py-2 md:px-8 md:py-3 bg-[#004684] text-white text-[10px] md:text-[12px] font-bold rounded-full transition-all hover:bg-[#004684]/90 active:scale-95 shadow-md shadow-blue-900/5 cursor-pointer"
                  >
                    Buat Janji Temu
                  </button>
                  <Link
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="lg:hidden w-full flex flex-col gap-4">
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  inputMode="search"
                  enterKeyHint="search"
                  className="w-full border border-slate-200 py-2.5 pl-10 pr-4 outline-none focus:border-[#004684] text-base bg-white"
                  style={{ fontSize: "16px" }}
                />
              </div>
              ...
              >
                <Stethoscope size={20} className="text-[#004684]" />
              </button>
              ...
              <button
                ...
                title="Filter Hari"
              >
                <CalendarDays size={20} className="text-[#004684]" />
              </button>
            </div>
            ...
            <AnimatePresence>
              {showMobileSpecialtyModal && (
                ...
                >
                  <div className="p-2">
                    <div className="px-4 py-2 text-xs font-bold text-[#004684] sticky top-0 bg-white">
                      Pilih Spesialis
                    </div>
                      ...
                      <button
                        ...
                        className={`w-full text-left px-4 py-2 text-sm rounded-md transition-all ${
                          tempFilter.specialty === s
                            ? "bg-[#004684]/10 text-[#004684] font-semibold"
            ...
            <AnimatePresence>
              {showMobileDayModal && (
                ...
                >
                  <div className="p-2">
                    <div className="px-4 py-2 text-xs font-bold text-[#004684] bg-white">
                      Pilih Hari
                    </div>
                    {DAYS.map((d) => (
                      <button
          ...
          <aside className="hidden lg:block w-1/3 xl:w-1/4 lg:sticky lg:top-45 z-30">
            <div className="border border-slate-200 p-8 bg-white rounded-none shadow-sm h-fit">
              <div className="flex items-center gap-3 mb-8 text-[#004684] border-b border-slate-50 pb-4">
                <FilterIcon size={18} />
              ...
              <div className="mb-6">
                <label
                  htmlFor="doctor-name"
                  className="block text-sm font-bold text-[#004684] mb-2"
                >
                  Nama Dokter
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full border-b border-slate-200 py-2 pl-7 outline-none focus:border-[#004684] text-sm bg-transparent rounded-none"
                  />
                </div>
              </div>
              ...
              <button
                ...
                className="w-full bg-[#004684] text-white py-4 font-bold rounded-full cursor-pointer transition-all hover:bg-[#004684]/90 active:scale-[0.98]"
              >
                Temukan Dokter
              </button>
            </div>
