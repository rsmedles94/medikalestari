  ...
  return (
    <section className="relative w-full bg-transparent overflow-hidden pt-4 md:pt-10">
      ...
      <div className="hidden md:absolute md:inset-0 md:flex md:flex-col md:items-end md:justify-end md:z-20 md:pr-15 md:pb-15 md:pointer-events-none">
        <div className="md:pointer-events-auto bg-[#003f88] rounded-md shadow-lg p-5">
          {/* titlr */}
          ...
          >
            ...
            <div className="flex items-center justify-center p-3">
              <button
                ...
                className="w-full h-12 rounded-full bg-[#003f88] flex items-center justify-center gap-2 text-white active:scale-95 transition cursor-pointer"
              >
