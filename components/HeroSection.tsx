          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              <div className="flex-1 px-5 py-4 border-b md:px-8 md:border-b-0 md:border-r border-gray-100">
                <p className="text-xs text-[#153d6f] font-semibold mb-1">
                  Nama Dokter
                </p>
              ...
              <div className="flex items-center justify-center p-3">
                <button
                  ...
                  className="w-full md:w-14 h-12 md:h-14 rounded-full md:rounded-full bg-[#153d6f] flex items-center justify-center gap-2 text-white active:scale-95 transition cursor-pointer"
                >
  ...
  return (
    <section className="relative w-full bg-transparent overflow-hidden pt-4 md:pt-10">
      ...
      <div className="hidden md:absolute md:inset-0 md:flex md:flex-col md:items-end md:justify-end md:z-20 md:pr-15 md:pb-15 md:pointer-events-none">
        <div className="md:pointer-events-auto bg-[#153d6f] rounded-md shadow-lg p-5">
          {/* titlr */}
          ...
          >
            ...
            <div className="flex items-center justify-center px-3">
              <button
                ...
                className="h-14 px-4 rounded-full bg-white flex items-center justify-center text-[#153d6f] active:scale-95 transition cursor-pointer"
              >
          ...
          >
            ...
            <div className="flex items-center justify-center p-3">
              <button
                ...
                className="w-full h-12 rounded-full bg-[#153d6f] flex items-center justify-center gap-2 text-white active:scale-95 transition cursor-pointer"
              >
