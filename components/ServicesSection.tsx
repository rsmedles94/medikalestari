...
const ServiceSection = () => {
  ...
  return (
    <section className="w-full bg-[#014f86]/5 py-10">
            ...
            : serviceData.map((item, index) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 z-0">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-b from-white/40 via-[#014f86]/80 to-[#014f86] opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-500 z-10" />
                  </div>
                  ...
                  <div className="relative z-20 p-8 h-full flex flex-col items-start text-left">
                    ...
                    <div className="mt-6 opacity-100 translate-y-0 md:opacity-0 md:translate-y-4 md:group-hover:opacity-100 md:group-hover:translate-y-0 transition-all duration-500">
                      <button
                        ...
                        className="group/btn flex items-center gap-2 bg-white text-[#014f86] px-8 py-2.5 rounded-2xl text-xs font-bold uppercase tracking-widest shadow-lg active:scale-95 transition-all cursor-pointer overflow-hidden"
                      >
