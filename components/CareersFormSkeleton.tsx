    ...
    <div className="min-h-screen bg-white">
      <main className="max-w-2xl mx-auto px-4 py-12">
        ...
        <header className="relative w-full mb-12">
          <div className="w-full h-64 md:h-80 bg-white border border-slate-100 overflow-hidden shadow-sm relative">
            <div className="absolute inset-0 bg-linear-to-r from-transparent via-slate-300/30 to-transparent animate-shimmer" />
          </div>
        </header>

        {/* Form Skeleton */}
        <section className="bg-white  shadow-lg p-8">
          {/* Grid Skeletons */}
          ...
          <div className="mb-6 space-y-2">
            <div className="h-4 w-40 bg-slate-200  animate-shimmer" />
          ...
          {/* Button Skeleton */}
          <div className="h-12 bg-slate-200 animate-shimmer" />
        </section>
      </main>
    </div>
  );
