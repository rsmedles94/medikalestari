  ...
  const renderCard = (item: KisahItem, index: number) => (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[#003f88]/30 via-[#003f88]/70 to-[#003f88]/90 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10" />
      </div>
  ...
  return (
    <section className="w-full bg-white py-12 font-sans">
      ...
      <div className="max-w-[1160px] mx-auto px-4 md:px-6">
        {/* Judul Utama */}
        <h2 className="text-2xl md:text-4xl font-bold text-[#003f88] text-center mb-10">
          Kisah Pasien
        </h2>
        ...
        <div className="mt-10 text-center">
          <Link
            href="/kisah-pasien"
            className="inline-flex items-center gap-1.5 text-xs font-medium text-[#003f88] hover:text-[#e67e22] hover:underline transition-colors"
          >
