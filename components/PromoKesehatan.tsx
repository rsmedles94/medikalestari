...
const PromoKesehatan = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="bg-[#173A87]/5 py-12 px-4 sm:px-6 lg:px-8 min-h-screen mt-10"
      ...
      <div className="relative z-10 max-w-[1180px] mx-auto md:px-8">
            ...
            : visibleData.map((item) => (
                <li key={item.id}>
                  <article className="bg-white border border-gray-100 flex flex-col h-full shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                    ...
                    <div className="p-4 md:p-5 flex flex-col grow text-center">
                      <h3 className="text-sm md:text-lg font-bold text-[#173A87] mb-3 min-h-12 flex items-center justify-center leading-tight">
                        {item.title}
                      </h3>
                      ...
                      <div className="mt-auto">
                        <button
                          type="button"
                          className="w-full py-2 border border-[#173A87] text-[#173A87] text-[10px] md:text-xs font-bold uppercase tracking-wider transition-colors hover:bg-[#173A87] hover:text-white"
                        >
                          Selengkapnya
                        </button>
                      </div>
        ...
        <div className="mt-12 text-center">
          <button
            ...
            className="text-[#173A87] text-xs md:text-sm font-bold uppercase tracking-widest underline underline-offset-4 decoration-2 transition-opacity hover:opacity-70"
          >
