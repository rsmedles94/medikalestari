...
const PromoKesehatan = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="bg-[#006360]/5 py-12 px-4 sm:px-6 lg:px-8 min-h-screen mt-10"
    >
      <div className="relative z-10 max-w-290 mx-auto md:px-8">
          ...
          {isLoading
            ...
            : visibleData.map((item) => (
                ...
                >
                  ...
                  <div className="p-4 md:p-5 flex flex-col grow text-center">
                    <h3 className="text-sm md:text-lg font-bold text-[#006360] mb-3 min-h-12 flex items-center justify-center leading-tight">
                      {item.title}
                    </h3>
                    ...
                    <div className="mt-auto">
                      <button className="w-full py-2 border border-[#006360] text-[#006360] text-[10px] md:text-xs font-bold uppercase tracking-wider transition-colors hover:bg-gray-50">
                        Selengkapnya
                      </button>
                    </div>
                  </div>
        ...
        <div className="mt-12 text-center">
          <button
            ...
            className="text-[#006360] text-xs md:text-sm font-bold uppercase tracking-widest underline underline-offset-4 decoration-2 transition-opacity hover:opacity-70"
          >
