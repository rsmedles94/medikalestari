...
const PromoKesehatan = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="bg-[#014f86]/5 py-12 px-4 sm:px-6 lg:px-8 min-h-screen mt-10"
            ...
            : visibleData.map((item) => (
                <li key={item.id}>
                  <article className="bg-white border border-gray-100 flex flex-col h-full shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                    ...
                    <div className="p-4 md:p-5 flex flex-col grow text-center">
                      <h3 className="text-sm md:text-lg font-bold text-[#014f86] mb-3 min-h-12 flex items-center justify-center leading-tight">
                        {item.title}
                      </h3>
                      ...
                      <div className="mt-auto">
                        <button
                          type="button"
                          className="w-full py-2 border border-[#014f86] text-[#014f86] text-[10px] md:text-xs font-bold uppercase tracking-wider transition-colors hover:bg-[#014f86] hover:text-white"
                        >
                          Selengkapnya
                        </button>
                      </div>
