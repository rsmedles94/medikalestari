      ...
      <div className="max-w-[1400px] mx-auto px-8 md:px-16 py-16 md:py-24">
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12 mb-20">
          ...
          <div className="max-w-2xl text-lg md:text-xl leading-relaxed font-light opacity-90">
            <p className="mb-4">
              RS Medika Lestari adalah sistem layanan kesehatan terintegrasi
              yang berdedikasi untuk memberikan perawatan terbaik.
            </p>
            <p>
              Kami menyediakan layanan rawat inap, rawat jalan, dan gawat
