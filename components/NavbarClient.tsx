...
const NavbarClient: React.FC<NavbarClientProps> = ({ logoNode }) => {
  ...
  return (
    <nav className="w-full font-sans sticky top-0 z-[100] bg-white shadow-sm">
      ...
      {/* --- Bottom Navbar --- */}
      <div className="hidden md:block relative w-full bg-[#005753] text-white z-30">
        <div
          className="absolute right-0 top-0 h-full w-[38%] bg-[#00423E] hidden lg:block"
    ...
    return (
      <Link
        ...
        className={`flex items-center gap-2 font-medium ${
          isMobile ? "text-[#005753] text-lg" : "text-white text-sm "
        }`}
        title="Panel Admin"
      >
