  ...
  if (loading) {
    return (
      <div className="w-full min-h-96 flex flex-col items-center justify-center">
        <Loader2 className="h-12 w-12 animate-spin text-[#014f86] mb-4" />
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full border border-slate-200 py-3 pl-10 pr-4 outline-none focus:border-[#014f86] text-sm bg-white"
              />
            </div>
        ...
        <div className="hidden lg:flex flex-wrap gap-2">
          <button
            ...
            className={`px-4 py-2 rounded-full font-medium transition-all text-sm whitespace-nowrap ${
              selectedSpecialty === null
                ? "bg-[#014f86] text-white shadow-md"
