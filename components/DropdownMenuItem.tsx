  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        {!flag && icon && <div className="text-[#014f86] shrink-0">{icon}</div>}
        ...
        <div className="w-0 opacity-0 -ml-4 group-hover:w-5 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300 ease-out">
          <ArrowRight size={18} style={{ color: "#014f86" }} />
        </div>

        {/* TEKS */}
        <span className="text-[14px] text-gray-700 group-hover:text-[#014f86] group-hover:font-medium transition-colors duration-300">
          {title}
        </span>
      </div>
