      ...
      <section className="py-12 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="space-y-12">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                    <div className="flex items-center justify-center h-8 w-8 rounded-full bg-[#004684] text-white font-bold">
                      1
                    </div>
                  </div>
                  <div className="ml-4">
            ...
            {/* Kontak */}
            <div className="bg-blue-50 border-l-4 border-[#004684] p-6 rounded">
              <h3 className="text-lg font-bold text-[#004684] mb-3">
                Hubungi Tim Kami
              </h3>
