...
const Pertanggungjawaban = () => {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Header */}
      <section className="bg-gradient-to-r from-[#003366] to-[#003366] text-white py-8 px-6">
      ...
      <section className="py-12 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="space-y-12">
            {/* Tanggung Jawab RS */}
            <div>
              <h2 className="text-3xl font-bold text-[#003366] mb-6 pb-4 border-b-2 border-[#003366]">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                    <div className="flex items-center justify-center h-8 w-8 rounded-full bg-[#003366] text-white font-bold">
                      1
                    </div>
                  </div>
                  <div className="ml-4">
          ...
          <div className="mt-12 flex justify-between items-center pt-6 border-t">
            <Link
              ...
              className="text-[#003366] hover:text-[#001e3d] font-semibold flex items-center"
            >
              <svg
